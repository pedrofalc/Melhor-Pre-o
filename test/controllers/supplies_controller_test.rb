...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { date: @supply.date, fuel: @supply.fuel, gasStation: @supply.gasStation, km: @supply.km, liter: @supply.liter, price: @supply.price, user: @supply.user } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { date: @supply.date, fuel: @supply.fuel, gasStation: @supply.gasStation, km: @supply.km, liter: @supply.liter, price: @supply.price, user: @supply.user } }
